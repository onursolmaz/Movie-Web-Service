...
import com.akbank.moviewebservice.model.MovieResponse;
...
public class MovieService implements IMovieService{
    ...
    public List<Movie> search(String name) {
        ...
        ResponseEntity<MovieResponse> response=this.restTemplate.exchange(url, HttpMethod.GET,this.requestEntity,MovieResponse.class);
        MovieResponse movieResponse=response.getBody();
        return movieResponse.getResult();
    }
